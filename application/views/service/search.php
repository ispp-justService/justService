	...
	<hr>
		...
		<?php if($customer->type == 'Freelance'): ?>
		   <div class="panel-heading" style="background-color: #7DED58;">
				<i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&nbsp;<a style="color: #000000;" href="<?php echo site_url("customer/showProfile/".$customer->customer_id) ?>"><?php echo $customer->name ?></a>
		<?php else: ?>
		      ...
		      <div class="panel-body">
				...
				<div class="pull-right">	
					<?php if($this->session->id && $this->session->role == "APP_USER"): ?>
						...
						<?php echo get_creation_service_modal($customer->customer_id , site_url('app_user/createPendingService'), $request_uri) ?>
					<?php endif; ?>
				</div>
		   </div><!-- /panel-body-->
		</div><!-- /panel-default-->
